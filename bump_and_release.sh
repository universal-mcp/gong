...
echo "Generating tools README for src/universal_mcp_gong/app.py..."
universal_mcp readme src/universal_mcp_gong/app.py

# Stage the changed file
git add pyproject.toml src/universal_mcp_gong/README.md
